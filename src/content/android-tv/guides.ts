...
export const androidTvBestApps: AndroidTvApp[] = [
...
export const androidTvMoreApps: AndroidTvApp[] = [
...
export const androidTvDownloadApps: AndroidTvApp[] = [
