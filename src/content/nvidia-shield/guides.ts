...
export const nvidiaShieldBestApps: NvidiaShieldApp[] = [
...
export const nvidiaShieldMoreApps: NvidiaShieldApp[] = [
...
export const nvidiaShieldDownloadApps: NvidiaShieldApp[] = [
