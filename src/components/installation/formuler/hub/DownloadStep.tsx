...
import { formulerDownloadApps } from "@/content/formuler/guides";
import { formulerDownloadStep as data } from "@/content/formuler/download-step";
import AppleTvStepBadge from "../../shared/StepBadge";
import parseInlineLinks from "../../shared/parseInlineLinks";

export default function FormulerHubDownloadStep() {
  return (
