...
import { nvidiaShieldDownloadApps } from "@/content/nvidia-shield/guides";
import { nvidiaShieldSummaryStep as data } from "@/content/nvidia-shield/summary-step";
import AppleTvStepBadge from "../../shared/StepBadge";

export default function NvidiaShieldHubSummaryStep() {
  return (
    <section className="mx-auto max-w-7xl px-6 py-8">
      <div className="rounded-3xl border border-white/10 bg-white/[0.02] px-6 py-14 sm:px-10">
        ...
        <div className="mt-12 grid grid-cols-1 gap-6 lg:grid-cols-2">
          ...
          <div className="relative min-h-64 overflow-hidden rounded-2xl border border-white/10 bg-white">
            <Image
              src={data.image}
              alt="Nvidia Shield"
              fill
