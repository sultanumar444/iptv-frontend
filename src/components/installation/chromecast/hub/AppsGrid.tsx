...
function AppCard({ app }: { app: ChromecastApp }) {
  const content = (
    <>
...
function AppButton({ app }: { app: ChromecastApp }) {
  return app.slug ? (
    <Link
      href={`/installationsguider/apple-tv/${app.slug}`}
...
export default function ChromecastHubAppsGrid() {
  return (
      ...
      <div className="rounded-3xl border border-white/10 bg-white/[0.02] px-6 py-14 sm:px-10">
        <div className="mx-auto max-w-3xl text-center">
          ...
          <p className="mt-5 text-white/70">
            När du ska komma igång med iptv chromecast så börjar du med att
