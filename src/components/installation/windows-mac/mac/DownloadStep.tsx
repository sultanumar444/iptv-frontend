...
import { macDownloadApps } from "@/content/windows-mac/mac/guides";
import { macDownloadStep as data } from "@/content/windows-mac/mac/download-step";
import parseInlineLinks from "../../shared/parseInlineLinks";

export default function MacHubDownloadStep() {
  return (
