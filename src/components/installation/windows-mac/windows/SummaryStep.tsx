...
import { windowsDownloadApps } from "@/content/windows-mac/windows/guides";
import { windowsSummaryStep as data } from "@/content/windows-mac/windows/summary-step";
import AppleTvStepBadge from "../../shared/StepBadge";

export default function WindowsHubSummaryStep() {
  return (
    <section className="mx-auto max-w-7xl px-6 py-8">
      <div className="rounded-3xl border border-white/10 bg-white/[0.02] px-6 py-14 sm:px-10">
        ...
        <div className="mt-12 grid grid-cols-1 gap-6 lg:grid-cols-2">
          <div className="relative aspect-[3/4] overflow-hidden rounded-2xl border border-white/10 bg-white lg:order-1">
            <Image
              src={data.image}
              alt="IPTV på Windows-dator"
              fill
          ...
          <div className="flex flex-col justify-center rounded-2xl border border-white/10 bg-white/[0.03] p-8 lg:order-2">
