...
import { windowsDownloadStep as data } from "@/content/windows-mac/windows/download-step";
import parseInlineLinks from "../../shared/parseInlineLinks";

export default function WindowsHubDownloadStep() {
  return (
